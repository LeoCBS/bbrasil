...
import { BarChart3, Boxes, FileText, LayoutDashboard, Package, Settings, ShoppingCart, Users, UserRound } from "lucide-react";
...
export function AdminSidebar({ current }: { current: "produtos" | "clientes" | "vendedores" }) {
  return (
